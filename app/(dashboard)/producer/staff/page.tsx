...
export default function StaffPage(): React.ReactElement {
  ...
  const fetchData = React.useCallback(async () => {
    try {
      ...
      const invitationsRes = await fetch(`/api/organizations/${orgId}/invitations`);
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="mb-8 text-3xl font-bold">Staff Management</h1>
      ...
      <Tabs defaultValue="members" className="space-y-6">
        ...
        <TabsContent value="members">
          <StaffList
            ...
            description={`Team members of ${organization.companyName}`}
            canManage={true}
        ...
        <TabsContent value="permissions">
          <PermissionMatrix type="organization" />
        </TabsContent>
      </Tabs>
      ...
      <InviteStaffDialog
        ...
        type="organization"
        targetId={organization.id}
        targetName={organization.companyName}
