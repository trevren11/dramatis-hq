...
import { users, producerProfiles, auditions, auditionForms } from "@/lib/db/schema";
...
export async function generateMetadata({ params }: Props): Promise<{ title: string }> {
  ...
  return {
    title: `Form Builder - ${audition.title} | Dramatis`,
  };
}

export default async function ProducerFormBuilderPage({
  params,
